...
| :--- | :--- | :--- |
| `Start skill maintenance`, `Process feedback` | `TRIAGE_FEEDBACK` | Inspect Git state, read `feedback/20??-*.md`, present triage proposal for owner approval; execute `skills/maintain-architecture-skills/SKILL.md`. |
